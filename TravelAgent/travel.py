...
st.markdown("### Where are you planning!!?")
...
Researcher  = Agent(
    ...
    instructions=[
        ...
        "Gather all the required information on the destination, including climate,culture,suitable cloths and safety tips",
        "Find the popular attractions, landmarks and must visit places.",
        "Search for the activities that will best allingned with user's interest and travel style",
        "Prioritize information from reliable sources and official travel guides only.",
        "Provide well structured summaries with key insigths and recommendations."
...
ItineraryPlanner = Agent(
    ...
    instructions=[
        ...
        "Ensure the itinerary includes transportation options and travel time estimates.Type of dress if required",
...
hotel_restaurant_finder = Agent(
    ...
    instructions=[
        ...
        "Search for good reviews hotels near those locations from geniune sources."
...
if st.button("🚀 Generate Travel Plan"):
    with st.spinner("✈️ Fetching best flight options..."):
     ...
     # get the best attraction and activities for the given prefernces
    ...
    # get the hotel details for given input preferences
    ...
    # Dump above information with user prederences for personalised ai itinerary
    with st.spinner("🗺️ Creating your personalized itinerary..."):
        ...
        itinerary = ItineraryPlanner.run(planning_prompt, stream=False)
